...
*/
class Animal {
    constructor(name, age, isMammal, birthdate) {
        this.name = name;
        this.age = age;
        this.isMammal = isMammal;
        this.birthdate = birthdate;  // optional (can be undefined)
    }
}
...
*/
model.add(new Animal("Leo", 4, true, new Date("2018-06-12")));   // name, age, isMammal, birthdate
model.add(new Animal("Polly", 2, false));                       // no birthdate provided (optional)
model.add(new Animal("Max", 7, true, new Date("2014-09-01")));
